...
> [!TIP]
> For the quantitative benchmark scorecard evaluating 20 golden plant pathology scenarios, ablation studies, and formal metric formulations (Faithfulness 0.942, Context Recall 0.968, Context Precision 0.924), see [`docs/RAG_BENCHMARK_REPORT.md`](docs/RAG_BENCHMARK_REPORT.md).
