...
const HIGHLIGHTS = [
  ...
  {
    icon: ShieldCheck,
    title: 'Actionable Multi-Stage Treatment Plans',
    description: 'Immediate 24-48h field actions, OMRI organic controls, chemical dosages, and spray calculator.',
  },
]
        ...
        <div>
          ...
          >
            <span className="inline-flex items-center gap-1.5 rounded-full border border-emerald-500/20 bg-emerald-500/10 px-3 py-1 text-xs font-semibold text-emerald-600 dark:border-emerald-500/30 dark:bg-emerald-500/15 dark:text-emerald-400">
              <Activity size={13} />
              Multimodal Plant Pathology & RAG
            </span>
            <h1 className="font-display text-2xl font-bold tracking-tight text-slate-900 dark:text-ink-primary sm:text-3xl xl:text-4xl">
              Precision Crop Diagnostics & Grounded Agricultural Intelligence
            </h1>
            <p className="text-sm leading-relaxed text-slate-500 dark:text-ink-muted">
              Diagnose leaf pathology across 12 major crop species from a single photo, generate verified treatment
              schedules, and converse with indexed agronomic research documents.
            </p>
          </motion.div>
      ...
      <div className="flex flex-col justify-center px-6 py-12 lg:col-span-6 lg:px-12 xl:col-span-5 xl:px-16">
        ...
        >
          ...
          <div className="space-y-1 text-left">
            <h2 className="font-display text-2xl font-bold text-slate-900 dark:text-ink-primary">Welcome back</h2>
          ...
          <p className="text-center text-sm text-slate-500 dark:text-ink-muted">
            ...
            <Link to="/signup" className="font-semibold text-accent-600 hover:underline dark:text-accent-400">
              Sign up
            </Link>
          </p>
        </motion.div>
